...
function FeatureCard({
  ...
  return (
    <motion.div
      className="animated-cards relative w-full rounded-[16p]"
    ...
    >
      <div
        className={clsx(
          "group relative w-full overflow-hidden rounded-3xl border border-black/10 bg-gradient-to-blue from-neutral-900/90 to-stone-800 transition duration-300 dark:from-neutral-950/90 dark:to-neutral-800/90",
          "md:hover:border-transparent",
          bgClass
        )}
      >
        <div className="m-10 min-h-[450p] w-full">
                ...
                <span className="flex items-center gap-2 text-sm font-medium">
                  ...
                  >
                    {isCompleted ? (
                      ...
                      >
                        <IconCheck className="h-3 w-3 stroke-white stroke-[] text-white dark:stroke-black" />
                      </motion.div>
                    ) : (
                      <span
                        className={cn(
  ...
  />
        ...
        case 3:
          ...
          return (
            <motion.div
              className={clsx(
                "absolute left-2/4 top-1/3 flex w-[] -translate-x-1/2 -translate-y-[33%] flex-col gap-12 text-center text-2xl font-bold md:w-[60%]"
              )}
            ...
            >
              <AnimatedStepImage
                alt={image.alt}
                className="pointer-events-none top-[50%] w-[90%] overflow-hidden rounded-2xl border border-neutral-100/10 md:left-[35p] md:top-[30%] md:w-full dark:border-zinc-700"
                src="/cults.png"
                preset="fadeInScale"
                delay={0.1}
              />
  ...
  return (
    <FeatureCard {...props} step={step}>
      ...
      <motion.div
        ...
        className="absolute left-[] top-5 z-50 h-full w-full cursor-pointer md:left-0"
      >
